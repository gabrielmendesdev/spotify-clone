...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-primary/20 bg-gray-700">
      <SliderPrimitive.Range className="absolute h-full bg-primary bg-gray-200 group-hover:bg-[#1db954]" />
